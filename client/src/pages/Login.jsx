      ...
      >
        <div className="glass-effect-strong rounded-2xl p-8 shadow-2xl glacier-glow">
          ...
          <motion.div
            ...
            className="mt-6 p-4 rounded-lg glass-effect border border-glacier-500/20"
          >
            <p className="text-xs text-glacier-400 font-semibold mb-2">Demo Credentials:</p>
            <p className="text-xs text-gray-400">Admin: admin@netflix.com / admin123</p>
            <p className="text-xs text-gray-400">User: user@netflix.com / user123</p>
          </motion.div>
          ...
          >
            ...
            <Link to="/register" className="text-glacier-400 hover:text-glacier-300 font-semibold">
              Sign up
            </Link>
          </motion.p>
        </div>
